...
CREATE TABLE tbl_book_copies (
    book_copies_BookID  INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE tbl_book_loans (
    book_loans_BookID INT PRIMARY KEY AUTO_INCREMENT,
...
SELECT lb.library_branch_BranchName AS BranchName,bc.book_copies_No_Of_Copies AS NumberOfCopies
FROM tbl_book b
...
borrower's address. */
SELECT b.book_Title AS BookTitle,br.borrower_BorrowerName AS BorrowerName,br.borrower_BorrowerAddress AS BorrowerAddress
...
SELECT br.borrower_BorrowerName AS BorrowerName, br.borrower_BorrowerAddress AS BorrowerAddress,
